	...
	if (Type === "login") {
		...
		return (
			<form className="container" onSubmit={handleLogin}>
				...
				<div className="inputs">
					<p>Email</p>
					<input type="email" placeholder="Ex: joao@gmail.com" value={email} ref={emailRef} onChange={(e) => setEmail(e.target.value)} />
				</div>
				<div className="inputs">
					<p>Senha</p>
					<input type="password" placeholder="Ex: 12313$gxy" value={password} onChange={(e) => setPassword(e.target.value)}/>
				</div>
		...
		return (
			<form
				...
				<div className="inputs">
					<p>Nome completo</p>
					<input type="text" placeholder="Ex: João Souza Melo" value={name} onChange={(e) => setName(e.target.value)}/>
				</div>
				<div className="inputs">
					<p>Email</p>
					<input type="email" placeholder="Ex: joao@gmail.com" value={email} ref={emailRef} onChange={(e) => setEmail(e.target.value)} />
